...
namespace ShapesMatching
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Run_Click(object sender, EventArgs e)
        {
            ...
            Mat pattern;
            (pattern, contours1, hierarchy1) = FindContours(BitmapConverter.ToMat(Properties.Resources.testroi));
            ...
            Mat data;
            (data, contours2, hierarchy2) = FindContours(BitmapConverter.ToMat(Properties.Resources.test1));
